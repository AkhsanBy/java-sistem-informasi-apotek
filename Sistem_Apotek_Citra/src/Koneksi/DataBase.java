    ...
    public static Connection KoneksiDB() {
        if(conn == null){
            try {
                ...
                JOptionPane.showMessageDialog(null,"Selamat datang di aplikasi Sistem Informasi Apotek Citra Sehat","Pesan",JOptionPane.INFORMATION_MESSAGE);
            }catch (Exception ex) {
                JOptionPane.showMessageDialog(null,"Opps! terjadi kesalahan pada database","Pesan",JOptionPane.INFORMATION_MESSAGE);

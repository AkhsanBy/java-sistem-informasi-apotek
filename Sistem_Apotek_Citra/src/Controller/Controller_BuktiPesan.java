...
public class Controller_BuktiPesan {
    ...
    String[] header = new String[]{"KODE KATEGORI", "NAMA KATEGORI", "KODE OBAT", "NAMA OBAT", "HARGA", "QTY", "TOTAL"}; //deklarasi variable untuk membuat judul kolom pada objek JTable

 ...
 * @author praktek
 */
public class MKategoriObat extends javax.swing.JFrame {

    Controller_Kategori controller;
    public MKategoriObat() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Entry Kategori Obat");

        jLabel1.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel1.setText("ENTRY KATEGORI OBAT");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MKategoriObat.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MKategoriObat().setVisible(true);
            }
        });
    }
